/**
 * 게시글 작성 페이지 (TASK_WEB Step 3).
 * POST /api/posts. 로그인 필수. 위치(위도·경도) 선택 UI 골격.
 */
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <form onSubmit={handleSubmit} className="mx-auto max-w-2xl space-y-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="flex gap-4 pt-4">
          ...
          <Link to="/posts" className="rounded border border-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-50">
            취소
          </Link>
        </div>
      </form>
