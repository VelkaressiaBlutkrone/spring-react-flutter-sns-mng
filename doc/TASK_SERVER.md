...
| 기능      | RULE 2 (API 설계, **2.1.3 내부/Admin API 분리**, **2.1.4 URI 설계 규칙**, 예외, **2.2.6 Checked Exception 금지**, **2.3.2 트랜잭션·이벤트**, 상태) |
| 기술      | RULE 3 (계층, ORM/QueryDSL, 통신, **3.6 외부 라이브러리 관리**)                                                           |
...
> **문서 버전**: 1.0.2
> **기준**: PRD 1.0.0, RULE 1.0.7 (2.1.4 URI 설계, 3.6 외부 라이브러리, 7.1.3 Spring Boot REST URI)
> **최종 업데이트**: 2026-02-09
> **RULE 준수 점검**: doc/RULE_COMPLIANCE_CHECK.md (Step 1~15 완료)
